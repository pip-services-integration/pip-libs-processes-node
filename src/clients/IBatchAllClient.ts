export interface IBatchAllClient<T> {
     ...
     */
    downloadAll(correlationId: string, responseQueueName: string, requestId: string,
     ...
     * @param callback a callback function that returns null or error
     */
    uploadAll(correlationId: string, blobIds: string[], responseQueueName: string, requestId: string,
        callback: (err: any) => void): void;
}