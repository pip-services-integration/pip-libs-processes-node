...
export interface ITestAdapterClient extends ICapableClient, IReadWriteClient<TestEntity, string>, IBatchAllClient<TestEntity>, IBatchChangesClient<TestEntity> {
}
