...
exports.TransferProcess = void 0;
...
class TransferProcess extends logic_1.Process {
    constructor(processType, references, parameters) {
        ...
        this.addTask("Post", ChangePostTask_1.ChangePostTask, transferQueue, -1, pip_services3_commons_node_1.Parameters.fromTuples(logic_1.ProcessParam.IsInitial, true, logic_1.ProcessParam.IsFinal, true, ChangesTransferParam_1.ChangesTransferParam.PostAdapter, postAdapter));
    }
