...
class ChangePostTask extends Task_1.Task {
    makeRetryKey(entity) {
        ...
        if (te == null || ie == null)
            return null;
        return ie.id.toString() + '-' + pip_services3_commons_node_1.StringConverter.toString(te.change_time);
    }
        ...
        if (te != null) {
            if (te.deleted && !sendToUpdateAsyncOnly) {
                ...
                async.series([
                    ...
                    // Update on error
                    let entityAlreadyExistException = err;
                ...
                async.series([
                    ...
                    let entityNotFoundException = err;
    ...
    postEntityErrorHandler(err, callback) {
        let entityRequestReviewException = err;
        ...
        let entityPostponeException = err;
        if (entityPostponeException != null) {
            ...
            this.failAndRecoverProcess('Processing was postponed - ' + entityPostponeException.message, this.queue.getName(), this.message, postponeTimeout, (err) => {
